...
# Here, we use the larger dataset with 17 flower types. 
...
# We write the image file names into a list and then into a text file named "flowers17" for future use.
...
# Create a blank text file named flowers17 in the working directory
