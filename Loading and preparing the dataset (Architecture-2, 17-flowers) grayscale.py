...
line_file=0
flowersgs=np.zeros((len(files),28,28,1)) # the tensor which will hold the digital forms of the images

l=0

for line in open("flowers17gs.txt"): # loop over all entries of the text file
    # print(l+1)
    line=line.strip('\n')
    line_file=line
    # print line_4
    ...
    flowersgs[l]=img2 # populate the tensor with pixel values of each image
    l=l+1 # l ranges from 0 to 8188


print(flowersgs.shape)
